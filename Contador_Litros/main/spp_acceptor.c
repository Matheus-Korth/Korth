...
#define EXAMPLE_DEVICE_NAME "ESP_SPP_ACCEPTOR" // nome dispositivo
...
static void esp_spp_cb(esp_spp_cb_event_t event, esp_spp_cb_param_t *param)
{
    ...
    case ESP_SPP_DATA_IND_EVT:
        ...
        esp_buffer_char("", param->data_ind.data, param->data_ind.len);
        break;
...
void esp_buffer_char(const char *tag, const void *buffer, int buff_len)
{
    if (buff_len == 0)
    {
        return;
